...
public interface TaskManagementService {
    ...
    /**
     * Retrieves tasks for the "Smart" daily task view.
     *
     * Includes:
     * - All ACTIVE tasks that start within the given date range.
     * - All ACTIVE tasks that started before the startDate but are still open.
     *
     * @param startDate the start date of the range
     * @param endDate   the end date of the range
     * @return list of TaskManagementDto matching the criteria
     */
    List<TaskManagementDto> getSmartDailyTaskView(LocalDate startDate, LocalDate endDate);
